...
<style>
  ...
  *, *::before, *::after {{ box-sizing: border-box; margin: 0; padding: 0; }}
  ...
  /* ── Hero ────────────────────────────────────────────────────── */
  .hero {{
    background: linear-gradient(135deg, var(--pickle-dark) 0%, #166534 50%, #14532D 100%);
    color: white;
    padding: 2rem;
  ...
  .outlook-card.current {{ background: var(--pickle-bg); color: var(--pickle-dark); }}
...
<section class="hero">
  <div class="hero-left">
    <div class="division-badge">⭐ Division Leaders</div>
